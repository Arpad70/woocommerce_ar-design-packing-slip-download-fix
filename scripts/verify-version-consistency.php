...
$pluginFile = $pluginRoot . '/ar-design-packing-slip-download-fix.php';
...
if (! preg_match("/define\\(\\s*'ARD_PACKING_SLIP_FIX_VERSION'\\s*,\\s*'" . preg_quote($version, '/') . "'\\s*\\)/", $pluginSource)) {
	$errors[] = 'ARD_PACKING_SLIP_FIX_VERSION does not match VERSION file.';
}
