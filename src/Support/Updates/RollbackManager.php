...
{
	private const BACKUP_DIR = 'ard-packing-slip-fix-backups';
	...
	public function rollbackOnInstallFailure( $result, $hook_extra )
	{
		...
		return new \WP_Error(
			'ard_packing_slip_fix_rollback_performed',
			__(
				'Aktualizácia Ar Design Packing Slip Download Fix zlyhala. Predchádzajúca verzia bola automaticky obnovená zo zálohy.',
